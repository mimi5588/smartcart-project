...
- בחירת סופר, הגדרת תקציב דינמית והגדרת יעד זמן לקנייה.
...
- סיום קנייה שיוצר קבלה, שומר אותה בתובנות ומנקה את הרשימה לקנייה הבאה.
...
4. משנים תקציב ויעד זמן ומוודאים שהבחירה מתעדכנת.
...
8. לוחצים על סיום קנייה ורואים שהקבלה נשמרת בתובנות עם יעד הזמן.
9. עוברים לתובנות ורואים גרפים וקבלות.
10. עוברים לפרופיל, משנים העדפות ומוסיפים אדם למשק הבית.
11. מתנתקים ומתחברים שוב כדי לוודא שהמידע נשמר.
